    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Correo institucional @pucesi.edu.ec', max_length=254, unique=True)),
                ('is_2fa_enabled', models.BooleanField(default=True)),
                ('otp_secret', models.CharField(blank=True, default='', max_length=32)),
